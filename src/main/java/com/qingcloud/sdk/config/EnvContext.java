...
package com.shanhe.sdk.config;

import com.shanhe.sdk.constants.QCConstant;
import com.shanhe.sdk.request.ParamValidate;
import com.shanhe.sdk.service.TokenService;
...
public class EnvContext implements ParamValidate {
    ...
    /** @param host example: api.shanhe.com */
