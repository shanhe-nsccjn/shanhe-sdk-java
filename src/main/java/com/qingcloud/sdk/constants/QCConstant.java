...
package com.shanhe.sdk.constants;
...
public class QCConstant {
    ...
    public static final String SDK_NAME = "shanhe-sdk-java";
    ...
    public static final int HTTP_CLIENT_CONNECTION_TIMEOUT = 60; // SECONDS

    public static final int HTTP_CLIENT_READ_TIMEOUT = 100; // SECONDS

    public static final int HTTP_CLIENT_WRITE_TIMEOUT = 100; // SECONDS

    public static final String QC_CODE_FIELD_NAME = "status_code";

    public static final String QC_MESSAGE_FIELD_NAME = "message";

    public static final String DEFAULT_HOST = "api.shanhe.com";
