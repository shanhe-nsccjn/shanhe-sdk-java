...
public class ShanHeService {

    private EnvContext envContext;

    private String zone;

    public ShanHeService(EnvContext envContext) {
        this.envContext = envContext;
    }

    public ShanHeService(EnvContext envContext, String zone) {
        this.envContext = envContext;
        this.zone = zone;
    }
    ...
    /**
      ...
      *
      * <a href=https://docsv3.shanhe.com/api/zone/describe_zones.html>Documentation URL</a>
      */
